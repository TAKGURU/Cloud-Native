...
import com.example.crud.domain.UserInfoDomainService;
import com.example.crud.domain.model.UserInfo;
import com.example.crud.dto.UserInfoDto;
...
public class UserInfoService {
	...
	public UserInfoDto updateUserInfo(String name, UserInfoDto userInfoDto) {
		...
		userInfoDomainService.updateUserInfo(userInfo); return userInfoDto; 
	} 
	
	public void deleteUserInfo(String name) { userInfoDomainService.deleteUserInfo(name); }
